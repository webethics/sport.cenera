...
export const CreateEditClub: FC<Props> = ({
  toEditClub,
  onClubCreateOrEdit,
  onEditCancel,
}) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const res = await ClubService.createOrEditClub(
          club,
  ...
  const handleClubLogoChange = async (
  ...
  return (
    <Card>
      <CardHeader>
        <h4>
          {toEditClub ? `Edit Club ${toEditClub.club_name}` : "Create New Club"}
        </h4>
      </CardHeader>
      <CardBody>
              ...
              <GridContainer>
                ...
                <GridItem xs={12} sm={6} md={12} lg={6}>
                  <div className={classes.imageUploadContainer}>
                    ...
                    >
                      <FormControl
                        className={`${classes.fileUploadFormControl} ${classes.imagesUpload}`}
                      >
                        <FormLabel
                          htmlFor="btnClubImageFilePicker"
                          component="legend"
                        >
                          Club Image
                        </FormLabel>
        ...
        <Backdrop
          ...
          open={uploading || formik.isSubmitting}
        >
