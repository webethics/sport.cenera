...
export const GameInfo: FC = () => {
  ...
  const handleDeleteClick = async () => {
    await GameService.deleteGameInfo(
              ...
              <form onSubmit={formik.handleSubmit}>
                <GridContainer>
                  <GridItem xs={4} md={4}>
                    ...
                    <CustomInput
                      error={
                        touched.ticketprice && errors.ticketprice ? true : false
                      }
                      labelText="Lottery 2"
                      id="ticketprice"
                      formControlProps={{
                    ...
                    <CustomInput
                      error={
                        touched.kioskinfo && errors.kioskinfo ? true : false
                      }
                      labelText="Lottery 3"
                      id="kioskinfo"
                      formControlProps={{
                    ...
                    <CustomInput
                      error={
                        touched.nextgame1 && errors.nextgame1 ? true : false
                      }
                    ...
                    <CustomInput
                      error={
                        touched.nextgame2 && errors.nextgame2 ? true : false
                      }
                    ...
                    <CustomInput
                      error={
                        touched.spectators && errors.spectators ? true : false
                      }
