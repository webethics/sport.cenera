          ...
          <CardBody>
            ...
            {upcomingBookins.map((res:any)=>(
               ...
               <GridItem xs="4" sm="5" md="3" >
                 <h5 style={{ fontSize: "14px" }}>Team: <span className={classes.textColor}>{res.team}</span> </h5>
               ...
               <GridItem xs="4" sm="5" md="3" >
                  <h5  style={{ fontSize: "14px" }}>Location: <span className={classes.textColor}>{res.location}</span></h5> 
                  <h5  style={{ fontSize: "14px" }}>Warderobe:<span className={classes.textColor}>{res.Warderobe}</span></h5>
                  <h5  style={{ fontSize: "14px" }}>Activity: <span className={classes.textColor}>{res.activity}</span></h5>
               </GridItem>
 
               <GridItem xs="12" sm="5" md="3">
                 <GridContainer>
                   <GridItem xs="6" md="12"><Button color="info" style={{ width: "150px" }} onClick = {()=> handleEditActivity(res.id)}>Edit</Button></GridItem>
                   <GridItem xs="6" md="12"><Button color="danger" style={{ width: "150px" }} onClick={()=> handleDeleteActivity(res.id)} >Delete</Button></GridItem>
                 </GridContainer>
               </GridItem>
            ...
            <Button color="warning" className={classes.btnDelete} onClick = {()=> handleDeleteAll()}>Delete All Activity</Button>
